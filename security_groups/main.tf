...
resource "azurerm_network_security_group" "ehealth_security_group_data" {
...
resource "azurerm_subnet_security_group_association" "web" {
...
resource "azurerm_subnet_security_group_association" "logic" {
...
resource "azurerm_subnet_security_group_association" "data" {
